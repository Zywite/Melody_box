...
class PlaylistService:
    ...
    @staticmethod
    def add_song_to_playlist(db: Session, playlist_id: str, song_id: str) -> PlaylistSong:
    ...
    @staticmethod
    def remove_song_from_playlist(db: Session, playlist_id: str, song_id: str) -> PlaylistSong | None:
