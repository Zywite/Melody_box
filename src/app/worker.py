...
async def compute_fft(ctx, song_id: str) -> None:
    db = SessionLocal()
    try:
...
async def download_youtube(ctx, video_id: str, fmt: str, quality: str, title: str | None = None, artist: str | None = None) -> None:
    import yt_dlp
